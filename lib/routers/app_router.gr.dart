...
/// generated route for
/// [SleepDiaryPage]
class SleepDiaryRoute extends PageRouteInfo<void> {
  const SleepDiaryRoute({List<PageRouteInfo>? children})
      : super(
          SleepDiaryRoute.name,
          initialChildren: children,
        );

  static const String name = 'SleepDiaryRoute';
